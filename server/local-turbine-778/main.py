...
class MainPage(webapp2.RequestHandler):
  ...
  def get(self):
    ...
    dba=dataBaseClass()
    msg = dba.new_user_registry('shakira', '1111', False)
  ...
  def post(self):
    ...
    if user_request['action'] == 'new_user_registry':
      res,msg,data = dba.new_user_registry(user_request['username'],user_request['password'],user_request['isAdmin'])       
      result = {'action' : user_request['action'],'return value' : res,
                  'msg' : msg, 'data' : data}
